...
const jano = new Discord.Client("OTY2NDQ4NTQ4ODUxOTA0NTY0.YmB5WQ.0xoHb1zyJG5Tzrt7HWSfvvEWPko");
...
///////////////////
jano.on("ready", () => {
  var join = jano.channels.get("965996097464070164"); /// id voice
  if (join) join.join();
});
///////////////////
jano2.on("ready", () => {
...
jano.login("OTY2NDQ4NTQ4ODUxOTA0NTY0.YmB5WQ.0xoHb1zyJG5Tzrt7HWSfvvEWPko");
jano2.login("");
jano3.login("");
jano4.login("");
jano5.login("");
